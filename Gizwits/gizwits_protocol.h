...
* @{
*/
#define PRODUCT_KEY "eee98c5499b74434859fc3d5e11149ab"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "b2774c1ef9594d5bb15ed982e2155650"
...
* @{
*/
#define say_flag_BYTEOFFSET                    0
#define say_flag_BITOFFSET                     0
#define say_flag_LEN                           1
#define over_weight_flag_BYTEOFFSET                    3
#define over_weight_flag_BITOFFSET                     0
#define over_weight_flag_LEN                           1

#define weight_data_RATIO                         1
#define weight_data_ADDITION                      0
#define weight_data_MIN                           0
#define weight_data_MAX                           5000
/**@} */
